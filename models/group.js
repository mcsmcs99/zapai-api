...
module.exports = (sequelize, DataTypes) => {
  class Group extends Model {
    static associate (models) {
      ...
      // ✅ Locale / Currency (FKs novas)
      Group.belongsTo(models.Locale, { foreignKey: 'locale_id', as: 'locale' })
      Group.belongsTo(models.Currency, { foreignKey: 'currency_id', as: 'currency' })
  ...
  Group.init(
    {
      ...
      // ✅ remove os campos antigos (locale / currency_code) e troca por FKs
      locale_id: { type: DataTypes.INTEGER.UNSIGNED, allowNull: true },
      currency_id: { type: DataTypes.INTEGER.UNSIGNED, allowNull: true },
